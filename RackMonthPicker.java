...
import com.app.radiocity.listener.DateMonthDialogListener;
import com.app.radiocity.listener.OnCancelMonthDialogListener;
...
public class RackMonthPicker {
    ...
    public RackMonthPicker setMonthType(com.app.radiocity.other.MonthType monthType) {
    ...
    private class Builder implements MonthAdapter.OnSelectedListener{
        ...
        private Builder() {
            ...
            setColorTheme(getColorByThemeAttr(context, android.R.attr.colorPrimary, R.color.theme));
        }
        ...
        public void setColorTheme(int color) {
            ...
            linearToolbar.setBackgroundColor(Color.WHITE);
